...
export default function Cadastro() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (imagem) {
      uploadFileName = await enviarFotoParaApi(imagem);
      if (!uploadFileName) {
        exibirModalDeErroOuSucesso("Erro", "Cadastro cancelado por falha no upload da iamgem.");
        return;
      }
    }
    const novoBolo: Bolo = {
      ...
      imagens: uploadFileName ? [uploadFileName] : []
    }
